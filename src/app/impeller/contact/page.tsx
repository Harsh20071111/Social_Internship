...
export default function ImpellerContactPage() {
  return (
    <PuckPage
      hero="Contact Us"
      eyebrow="Pump Spares Division"
      subtitle="Get in touch with the Bhakti Impellers engineering & sales team"
    >
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1fr]">
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-wider text-[#a7c8ff] mt-1 bg-[#001836] w-fit px-2 py-0.5 rounded-sm">
                Pump Components & Impeller Division
              </p>
              ...
              <div className="mt-8 space-y-5">
                <ContactRow icon={Phone} label="OEM Contracts & Technical Sales" value="+91 94278 06585" href="tel:+919427806585" />
